...
var createBucket = function (opt, callback) {
    this.request("get", COS_API.create, opt, function (data) {
        callback && callback(data);
    });
};

var deleteBucket = function (opt, callback) {
    this.request("del", COS_API.delete, opt, function (data) {
        callback && callback(data);
    });
};

var getBucketMeta = function (opt, callback) {
    this.request("get", COS_API.getInfo, opt, function (data) {
        callback && callback(data);
    });
};
...
var setBucketMeta = function (opt, callback) {
    ...
    this.request("put", COS_API.setInfo, opt, function (data) {
        callback && callback(data);
    });
};
